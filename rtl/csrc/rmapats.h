...
extern "C" {
#endif
void  hs_0_M_0_0__synth_check_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_5__synth_check_simv_daidir (UB  * pcode, UB  val);
void  hs_0_M_1_0__synth_check_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_5__synth_check_simv_daidir (UB  * pcode, UB  val);
void  hs_0_M_2_21__synth_check_simv_daidir (UB  * pcode, vec32  * I1094, U  I982);
void  hs_0_M_2_0__synth_check_simv_daidir (UB  * pcode, vec32  * I1094, U  I982);
void  hs_0_M_2_5__synth_check_simv_daidir (UB  * pcode, U  I982);
void  hs_0_M_3_0__synth_check_simv_daidir (UB  * pcode, vec32  * I1094, U  I982);
void  hs_0_M_4_0__synth_check_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_4_5__synth_check_simv_daidir (UB  * pcode, UB  val);
void  hs_0_M_5_0__synth_check_simv_daidir (UB  * pcode, vec32  * I1094, U  I982);
void  hs_0_M_6_21__synth_check_simv_daidir (UB  * pcode, vec32  * I1094, U  I982);
void  hs_0_M_6_0__synth_check_simv_daidir (UB  * pcode, vec32  * I1094, U  I982);
void  hs_0_M_6_5__synth_check_simv_daidir (UB  * pcode, U  I982);
void  hs_0_M_7_0__synth_check_simv_daidir (UB  * pcode, scalar  val);
